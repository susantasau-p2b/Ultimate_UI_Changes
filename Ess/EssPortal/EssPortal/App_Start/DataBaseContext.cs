...
namespace EssPortal.App_Start
{
    public class DataBaseContext : DbContext
    {
        ...
        public DbSet<EssPortal.Models.EmpDocument> EmpDocument { get; set; }
        ...
        // IR Module added on 09/01/2023 by Anandrao
        ...
        protected override void OnModelCreating(DbModelBuilder db)
        {
            ...
            if (Migration)
            {
                Database.SetInitializer<DataBaseContext>(new MigrateDatabaseToLatestVersion<DataBaseContext, EssPortal.Migrations.Configuration>("DataBaseContext"));
            }
            else
            {
