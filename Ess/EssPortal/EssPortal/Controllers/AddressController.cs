...
namespace EssPortal.Controllers
{
    ...
    public class AddressController : Controller
    {
        ...
        {
            //var id = new Test();
            return View("~/Views/Shared/_Address.cshtml");
        }
                    ...
                    if (Auth == false)
                    {
                        ...
                        if (ModelState.IsValid)
                        {
                            ...
                            using (TransactionScope ts = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
                            {
                                ...
                                {
                                    blog = context.Address.Where(e => e.Id == data).Include(e => e.Country).Include(e => e.Area).Include(e => e.City)
                                ...
                                int a = EditS(Country, State, StateRegion, District, Taluka, City, Area, data, add, add.DBTrack);
                                ...
                                return Json(new Utility.JsonReturnClass { Id = blog.Id, Val = query.FullAddress, success = true, responseText = Msg }, JsonRequestBehavior.AllowGet);
