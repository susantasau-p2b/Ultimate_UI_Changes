...
namespace System.Data.Entity
{
    public static class DbContextExtensions
    {
        ...
        public static DbContext RefreshEntites(this DbContext dbContext, RefreshMode refreshMode, Type entityType)
        {
            ...
            //var objectsToRefresh = new List<objectContext.Object>();
            //var noNullsAndRepeateds = objectContext.Where(o => o. != null).Distinct().ToList(); 
            ...
            for (var i = 0; i < refreshableObjects.Count(); i++)
            {
                if (refreshableObjects[i] != null)
                {
                    objectContext.Refresh(RefreshMode.StoreWins, refreshableObjects[i]);
                }
            }
