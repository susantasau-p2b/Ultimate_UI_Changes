...
{
    public class SuccessionModelController : Controller
    {
        //
        // GET: /SuccessionModel/
        public ActionResult Index()
        {
            ...
            return View("~/Views/CMS/MainViews/SuccessionModel/Index.cshtml");
        }
        ...
        [HttpPost]
        public ActionResult EditSave(SuccessionModel c, int data, FormCollection form)
        {
            ...
            using (DataBaseContext db = new DataBaseContext())
            {
                try
                {
                    using (TransactionScope ts = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
                    {
                        ...
                        var db_data = db.SuccessionModel.Where(e => e.Id == data).FirstOrDefault();
                        TempData["RowVersion"] = db_data.RowVersion;
                        SuccessionModel CMS_SuccessionModel = db.SuccessionModel.Find(data);
                        TempData["CurrRowVersion"] = CMS_SuccessionModel.RowVersion;
                        if (DBTrackFile.ByteArrayCompare((byte[])TempData["CurrRowVersion"], (byte[])TempData["RowVersion"]) == true)
                        {
                            c.DBTrack = new DBTrack
                            {
                                CreatedBy = CMS_SuccessionModel.DBTrack.CreatedBy == null ? null : CMS_SuccessionModel.DBTrack.CreatedBy,
                                CreatedOn = CMS_SuccessionModel.DBTrack.CreatedOn == null ? null : CMS_SuccessionModel.DBTrack.CreatedOn,
                                Action = "M",
                                ModifiedBy = SessionManager.UserName,
                                ModifiedOn = DateTime.Now
                            };

                            CMS_SuccessionModel.Id = data;
                            CMS_SuccessionModel.Code = c.Code;
                            CMS_SuccessionModel.ModelName = c.ModelName;
                            CMS_SuccessionModel.ModelDescription = c.ModelDescription;
                            CMS_SuccessionModel.CreatedDate = c.CreatedDate;
                            CMS_SuccessionModel.DBTrack = c.DBTrack;
                            CMS_SuccessionModel.AppraisalAttributeModel = c.AppraisalAttributeModel;
                            CMS_SuccessionModel.AppraisalBusinessApprisalModel = c.AppraisalBusinessApprisalModel;
                            CMS_SuccessionModel.AppraisalKRAModel = c.AppraisalKRAModel;
                            CMS_SuccessionModel.AppraisalPotentialModel = c.AppraisalPotentialModel;
                            CMS_SuccessionModel.PastExperienceModel = c.PastExperienceModel;
                            CMS_SuccessionModel.PersonnelModel = c.PersonnelModel;
                            CMS_SuccessionModel.QualificationModel = c.QualificationModel;
                            CMS_SuccessionModel.ServiceModel = c.ServiceModel;
                            CMS_SuccessionModel.SkillModel = c.SkillModel;
                            CMS_SuccessionModel.TrainingModel = c.TrainingModel;
                            db.SuccessionModel.Attach(CMS_SuccessionModel);
                            db.Entry(CMS_SuccessionModel).State = System.Data.Entity.EntityState.Modified;
                            db.SaveChanges();
                        }
                        ts.Complete();
                    }
        ...
        public ActionResult GetSuccessionData(string data, string data2)
        {
            using (DataBaseContext db = new DataBaseContext())
            {

                var qurey = db.SuccessionModel.ToList();
        ...
        public class returndatagridDataclass //Parentgrid
        {
            public string Id { get; set; }
            public string ModelObjectList { get; set; }
            public string SuccessionModelObjectType { get; set; }
        ...
        public async Task<ActionResult> Delete(int data)
        {
            ...
            using (DataBaseContext db = new DataBaseContext())
            {
                try
                {
                    SuccessionModel SuccessionModels = db.SuccessionModel
                        .Include(e => e.AppraisalAttributeModel)
                        .Include(e => e.AppraisalBusinessApprisalModel)
                        .Include(e => e.AppraisalKRAModel)
                        .Include(e => e.AppraisalPotentialModel)
                    ...
                    using (TransactionScope ts = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
                    {
                        DBTrack dbT = new DBTrack
                        {
                            ...
                            ModifiedBy = SessionManager.UserName,
                            ModifiedOn = DateTime.Now,
                            CreatedBy = SuccessionModels.DBTrack.CreatedBy != null ? SuccessionModels.DBTrack.CreatedBy : null,
                            CreatedOn = SuccessionModels.DBTrack.CreatedOn != null ? SuccessionModels.DBTrack.CreatedOn : null,
                            IsModified = SuccessionModels.DBTrack.IsModified == true ? false : false//,

                        };
                        db.Entry(SuccessionModels).State = System.Data.Entity.EntityState.Deleted;
        ...
        public ActionResult SuccessionModel_Grid(ParamModel param, string y, string selectedtextcmn)
        {
            using (DataBaseContext db = new DataBaseContext())
            {
                try
                {
                    ...
                    IEnumerable<SuccessionModel> fall;
                    ...
                    Func<SuccessionModel, string> orderfunc = (c =>
                    ...
                    if (dcompanies.Count == 0)
                    {
                        ...
                        foreach (var item in fall)
                        {
                            result.Add(new returndatagridDataclass
                            {
                                Id = item.Id.ToString(),
                                //ModelObjectList = ModelObjectList,
                                //SuccessionModelObjectType = SuccessionModelObjectType,
                                Code = item.Code,
        ...
        public ActionResult A_SuccessionModel_Grid(int data)
        {
            using (DataBaseContext db = new DataBaseContext())
            {
                ...
                var db_data = db.SuccessionModel
                    .Include(e => e.AppraisalAttributeModel)
                    .Include(e => e.AppraisalBusinessApprisalModel)
                    .Include(e => e.AppraisalKRAModel)
                    .Include(e => e.AppraisalPotentialModel)
        ...
        //        var itemdata = db.SuccessionModel
        //            .Include(e => e.AppraisalAttributeModel)
        //             .Include(e => e.AppraisalBusinessApprisalModel)
        //             .Include(e => e.AppraisalKRAModel)
        //             .Include(e => e.AppraisalPotentialModel)
        ...
        //                SuccessionModelObjectType = TempData["CMSOBJECTTYPE2"].ToString()                 
        //            });
        ...
        [HttpPost]
        public ActionResult Create(SuccessionModel c, string Modellist, FormCollection form)
        {
            List<string> Msg = new List<string>();
            ...
            using (DataBaseContext db = new DataBaseContext())
            {
                try
                {
                    ...
                    if (db.SuccessionModel.Any(e => e.ModelName == c.ModelName))
                    {
                    ...
                    companycms_sps = db.CompanyCMS_SPS.Include(e => e.SuccessionModel).Where(e => e.Company.Id == company_Id).FirstOrDefault();
                    ...
                    if (ModelState.IsValid)
                    {
                        using (TransactionScope ts = new TransactionScope())
                        {
                            ...
                            SuccessionModel SuccessionModel = new SuccessionModel()
                            {
                            ...
                            db.SuccessionModel.Add(SuccessionModel);
                            db.SaveChanges();
                            if (companycms_sps != null)
                            {
                                List<SuccessionModel> SuccessionModel_list = new List<SuccessionModel>();
                                SuccessionModel_list.Add(SuccessionModel);
                                if (companycms_sps.SuccessionModel != null)
                                {
                                    SuccessionModel_list.AddRange(companycms_sps.SuccessionModel);
                                }
                                companycms_sps.SuccessionModel = SuccessionModel_list;
        ...
        public ActionResult Edit(int data)
        {
            ...
            {
                List<returndatagridDataclass> result = new List<returndatagridDataclass>();
                var returndata = db.SuccessionModel
                     .Where(e => e.Id == data).FirstOrDefault();
        ...
        {
            return View("~/Views/Shared/CMS/_SuccessionModelGridPartial.cshtml");
        ...
        //public ActionResult GridEditSave(SuccessionModel ypay, FormCollection form, string data, string data2)
        //{
        //    List<string> Msg = new List<string>();
        //    using (DataBaseContext db = new DataBaseContext())
        //    {
        ...
        public ActionResult GridDelete(int data, string data2)
        {
            using (DataBaseContext db = new DataBaseContext())
            {
                ...
                using (TransactionScope ts = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
                {
                    ...
                    {
                        case "AppraisalAttributeModel":
                            var db_dataattribute = db.SuccessionModel.Include(e => e.AppraisalAttributeModel).Where(e => e.Id == CompModelId).FirstOrDefault();

                            if (db_dataattribute != null)
                            {
                                db_dataattribute.AppraisalAttributeModel = null;
                                db.SuccessionModel.Attach(db_dataattribute);
                                db.Entry(db_dataattribute).State = System.Data.Entity.EntityState.Modified;
                                db.SaveChanges();
                        ...
                        case "AppraisalBusinessApprisalModel":
                            var db_databusiness = db.SuccessionModel.Include(e => e.AppraisalBusinessApprisalModel).Where(e => e.Id == CompModelId).FirstOrDefault();

                            if (db_databusiness != null)
                            {
                                db_databusiness.AppraisalBusinessApprisalModel = null;
                                db.SuccessionModel.Attach(db_databusiness);
                                db.Entry(db_databusiness).State = System.Data.Entity.EntityState.Modified;
                                db.SaveChanges();
                            ...
                            break;
                        case "AppraisalKRAModel":
                            var db_dataKRA = db.SuccessionModel.Include(e => e.AppraisalKRAModel).Where(e => e.Id == CompModelId).FirstOrDefault();

                            if (db_dataKRA != null)
                            {
                                db_dataKRA.AppraisalKRAModel = null;
                                db.SuccessionModel.Attach(db_dataKRA);
                                db.Entry(db_dataKRA).State = System.Data.Entity.EntityState.Modified;
                                db.SaveChanges();
                            ...
                            break;
                        case "AppraisalPotentialModel":
                            var db_datapotential = db.SuccessionModel.Include(e => e.AppraisalPotentialModel).Where(e => e.Id == CompModelId).FirstOrDefault();

                            if (db_datapotential != null)
                            {
                                db_datapotential.AppraisalPotentialModel = null;
                                db.SuccessionModel.Attach(db_datapotential);
                            ...
                            break;
                        case "PastExperienceModel":
                            var db_datapastexp = db.SuccessionModel.Include(e => e.PastExperienceModel).Where(e => e.Id == CompModelId).FirstOrDefault();

                            if (db_datapastexp != null)
                            {
                                db_datapastexp.PastExperienceModel = null;
                                db.SuccessionModel.Attach(db_datapastexp);
                            ...
                            break;
                        case "PersonnelModel":
                            var db_datapersonnel = db.SuccessionModel.Include(e => e.PersonnelModel).Where(e => e.Id == CompModelId).FirstOrDefault();

                            if (db_datapersonnel != null)
                            {
                                db_datapersonnel.PersonnelModel = null;
                                db.SuccessionModel.Attach(db_datapersonnel);
                                db.Entry(db_datapersonnel).State = System.Data.Entity.EntityState.Modified;
                                db.SaveChanges();
                            ...
                            break;
                        case "QualificationModel":
                            var db_dataqualification = db.SuccessionModel.Include(e => e.QualificationModel).Where(e => e.Id == CompModelId).FirstOrDefault();

                            if (db_dataqualification != null)
                            {
                                db_dataqualification.PersonnelModel = null;
                                db.SuccessionModel.Attach(db_dataqualification);
                                db.Entry(db_dataqualification).State = System.Data.Entity.EntityState.Modified;
                                db.SaveChanges();
                            ...
                            break;
                        case "ServiceModel":
                            var db_dataservice = db.SuccessionModel.Include(e => e.ServiceModel).Where(e => e.Id == CompModelId).FirstOrDefault();

                            if (db_dataservice != null)
                            {
                                db_dataservice.ServiceModel = null;
                                db.SuccessionModel.Attach(db_dataservice);
                                db.Entry(db_dataservice).State = System.Data.Entity.EntityState.Modified;
                                db.SaveChanges();
                            ...
                            break;
                        case "SkillModel":
                            var db_dataskill = db.SuccessionModel.Include(e => e.SkillModel).Where(e => e.Id == CompModelId).FirstOrDefault();

                            if (db_dataskill != null)
                            {
                                db_dataskill.SkillModel = null;
                                db.SuccessionModel.Attach(db_dataskill);
                                db.Entry(db_dataskill).State = System.Data.Entity.EntityState.Modified;
                                db.SaveChanges();
                            ...
                            break;
                        case "TrainingModel":
                            var db_datatraining = db.SuccessionModel.Include(e => e.TrainingModel).Where(e => e.Id == CompModelId).FirstOrDefault();

                            if (db_datatraining != null)
                            {
                                db_datatraining.TrainingModel = null;
                                db.SuccessionModel.Attach(db_datatraining);
                                db.Entry(db_datatraining).State = System.Data.Entity.EntityState.Modified;
                                db.SaveChanges();
