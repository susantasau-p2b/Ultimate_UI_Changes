...
{
    [AuthoriseManger]
    public class CandidateOnBoardingController : Controller
    {
        ...
        {
            return View("~/Views/Core/MainViews/CandidateOnBoarding/Index.cshtml");
        }
        ...
        public ActionResult GetCandidate(string data)
        {
            using (DataBaseContext db = new DataBaseContext())
            {
                ...
                var fall = db.ResumeCollection.Include(e => e.Candidate).Include(e => e.Candidate.CanName).Where(e => e.IsHRJoiningConfirmation == true)
                                                                .ToList();
                IEnumerable<SelectedCandidateData> ITProjectionList = null;
                List<SelectedCandidateData> model = new List<SelectedCandidateData>();
                SelectedCandidateData view = null;

                foreach (var z in fall)
                {
                    if (z.Candidate != null)
                    {
                        view = new SelectedCandidateData()
                               {
                                   Id = z.Id,
                ...
                IEnumerable<SelectedCandidateData> IE;
                IE = ITProjectionList;
                ...
                else
                {
                    ...
                    var r = (from ca in IE select new { srno = ca.Id, lookupvalue = ca.Fulldetails }).Distinct();
