...
{
    public class FinalShowCauseNoticeClarificarionServingController : Controller
    {
        //
        // GET: /FinalShowCauseNoticeClarificarionServing/
        public ActionResult Index()
        {
            return View("~/Views/IR/MainViews/FinalShowCauseNoticeClarificationServing/Index.cshtml");
        }
        public class P2BGridData
        {
            ...
            public string NoticeClarificationServingDate { get; set; }
        ...
        [HttpPost]
        public ActionResult Create(FinalShowCauseNoticeClarificarionServing c, FormCollection form, string EmpIr)
        {
            ...
            using (DataBaseContext db = new DataBaseContext())
            {
                try
                {
                    ...
                    string NoticeClarificationServingDate = form["NoticeClarificationServingDate"] == "0" ? "" : form["NoticeClarificationServingDate"];
                    if (NoticeClarificationServingDate != null && NoticeClarificationServingDate != "")
                    {
                        var val = DateTime.Parse(NoticeClarificationServingDate);
                        c.NoticeClarificationServingDate = val;
                    }
                    string ShowCauseClarificationServingMode = form["ShowCauseClarificationServingMode"] == "" ? null : form["ShowCauseClarificationServingMode"];
                    if (ShowCauseClarificationServingMode != null && ShowCauseClarificationServingMode != "")
                    {
                        int ShowCauseClarificationServingModeId = int.Parse(ShowCauseClarificationServingMode);
                        var val = db.ChargeSheetServingMode.Include(e => e.ChargeSheetServingModeName).Where(e => e.Id == ShowCauseClarificationServingModeId).SingleOrDefault();
                        c.ShowCauseClarificationServingMode = val;
                    }
                    ...
                    string ShowCauseNotice = form["ShowCauseNoticelist"] == "0" ? null : form["ShowCauseNoticelist"];
                    if (ShowCauseNotice != null && ShowCauseNotice != "")
                    {
                        var ids = Utility.StringIdsToListIds(ShowCauseNotice);
                    ...
                    using (TransactionScope ts = new TransactionScope())
                    {
                        ...
                        #region Already FinalShowCauseNoticeClarificarionServing enquiry records exist checking code
                        var EMPIR = db.EmployeeIR.Select(s => new
                        {
                            ...
                            EDP = s.EmpDisciplineProcedings.Select(r => new
                            {
                                EDPid = r.Id,
                                CaseNum = r.CaseNo,
                                FSNCS = r.FinalShowCauseNoticeClarificarionServing,
                        ...
                        if (EMPIR != null)
                        {
                            ...
                            foreach (var itemC in chkEMPIR.Where(e => e.FSNCS != null))
                            {
                                if (itemC.EDPid != 0 && itemC.CaseNum != null && itemC.FSNCS != null)
                                {
                        ...
                        FinalShowCauseNoticeClarificarionServing FinalShowCauseNoticeClarificarionServing = new FinalShowCauseNoticeClarificarionServing()
                        {
                            ...
                            Witness = c.Witness,
                            ShowCauseClarificationServingMode = c.ShowCauseClarificationServingMode,
                            NoticeClarificationServingDate = c.NoticeClarificationServingDate,
                            Narration = c.Narration,
                            DBTrack = c.DBTrack
                        };


                        var FinalShowCauseNoticeClarificarionServingValidation = ValidateObj(FinalShowCauseNoticeClarificarionServing);
                        if (FinalShowCauseNoticeClarificarionServingValidation.Count > 0)
                        {
                            foreach (var item in FinalShowCauseNoticeClarificarionServingValidation)
                            {

                                Msg.Add("FinalShowCauseNoticeClarificarionServing" + item);
                            }
                            return Json(new Utility.JsonReturnClass { success = false, responseText = Msg }, JsonRequestBehavior.AllowGet);
                        }
                        db.FinalShowCauseNoticeClarificarionServing.Add(FinalShowCauseNoticeClarificarionServing);
                        ...
                        try
                        {
                            ...
                            EmpDisciplineProcedings EmpDiscipline = new EmpDisciplineProcedings()
                            {
                                ...
                                FinalShowCauseNoticeClarificarionServing = db.FinalShowCauseNoticeClarificarionServing.Find(FinalShowCauseNoticeClarificarionServing.Id),
                                DBTrack = c.DBTrack
                            };
        ...
        public ActionResult P2BGrid(P2BGrid_Parameters gp)
        {
            try
            {
                ...
                IEnumerable<P2BGridData> FinalShowCauseNoticeClarificarionServing = null;
                List<P2BGridData> model = new List<P2BGridData>();
                P2BGridData view = null;
                ////var oemployeedata = db.FinalShowCauseNoticeClarificarionServing.OrderBy(e => e.Narration).ToList();
                var oemployeedata = db.EmployeeIR.Select(a => new
                {
                    ...
                    oEmpDiscipline = a.EmpDisciplineProcedings.Select(b => new
                    {
                        ...
                        oNoticeClarificationServingDate = b.FinalShowCauseNoticeClarificarionServing.NoticeClarificationServingDate,
                        oIsClosedServing = b.FinalShowCauseNoticeClarificarionServing.IsClosedServing.ToString(),
                        oIsNoticeRecd = b.FinalShowCauseNoticeClarificarionServing.IsNoticeRecd.ToString(),

                        oNarration = b.FinalShowCauseNoticeClarificarionServing.Narration,
                        oId = b.FinalShowCauseNoticeClarificarionServing.Id.ToString(),
                ...
                {
                    foreach (var item in itemIR.oEmpDiscipline.Where(e => e.oProceedStage == "16").OrderBy(o => o.oCaseNo))
                    {
                        view = new P2BGridData()
                        {
                            ...
                            NoticeClarificationServingDate = item.oNoticeClarificationServingDate != null ? item.oNoticeClarificationServingDate.Value.ToString("dd/MM/yyyy") : "",
                ...
                FinalShowCauseNoticeClarificarionServing = model;

                IEnumerable<P2BGridData> IE;
                if (!string.IsNullOrEmpty(gp.searchField))
                {
                    IE = FinalShowCauseNoticeClarificarionServing;
                        ...
                        jsonData = IE
                         .Where((e => (e.CaseNo.ToString().Contains(gp.searchString))
                             ...
                             || (e.IsClosedServing.ToString().ToUpper().Contains(gp.searchString))
                                 ...
                                 || (e.IsNoticeRecd.ToString().ToUpper().Contains(gp.searchString))
                                 || (e.NoticeClarificationServingDate.ToString().ToUpper().Contains(gp.searchString))

                                  || (e.Id.ToString().Contains(gp.searchString))
                                 )).ToList()
                        .Select(a => new Object[] { a.CaseNo, a.VictimName, a.ProceedingStage, a.NoticeClarificationServingDate, a.IsNoticeRecd, a.IsClosedServing, a.Narration, a.Id });
                    }
                    if (pageIndex > 1)
                    {
                        int h = pageIndex * pageSize;
                        jsonData = IE.Skip(pageIndex).Take(pageSize).Select(a => new Object[] { a.CaseNo, a.VictimName, a.ProceedingStage, a.NoticeClarificationServingDate, a.IsNoticeRecd, a.IsClosedServing, a.Narration, a.Id }).ToList();
                    }
                ...
                else
                {
                        ...
                        orderfuc = (c => gp.sidx == "CaseNo" ? c.CaseNo.ToString() :
                                         ...
                                         gp.sidx == "IsClosedServing" ? c.IsClosedServing.ToString() :
                                          gp.sidx == "IsNoticeRecd" ? c.IsNoticeRecd.ToString() :
                                            gp.sidx == "NoticeClarificationServingDate" ? c.NoticeClarificationServingDate.ToString() :
                    ...
                    if (gp.sord == "asc")
                    {
                        ...
                        jsonData = IE.Select(a => new Object[] { a.CaseNo, a.VictimName, a.ProceedingStage, Convert.ToString(a.NoticeClarificationServingDate), a.IsNoticeRecd, a.IsClosedServing, a.Narration, a.Id }).ToList();
                    }
                    else if (gp.sord == "desc")
                    {
                        IE = IE.OrderByDescending(orderfuc);
                        jsonData = IE.Select(a => new Object[] { a.CaseNo, a.VictimName, a.ProceedingStage, a.NoticeClarificationServingDate, a.IsNoticeRecd, a.IsClosedServing, a.Narration, a.Id }).ToList();
                    }
                    if (pageIndex > 1)
                    {
                        int h = pageIndex * pageSize;
                    ...
                    totalRecords = FinalShowCauseNoticeClarificarionServing.Count();
                }
                if (totalRecords > 0)
                {
        ...
        public async Task<ActionResult> Delete(int data)
        {
            ...
            using (DataBaseContext db = new DataBaseContext())
            {
                try
                {
                    FinalShowCauseNoticeClarificarionServing corporates = db.FinalShowCauseNoticeClarificarionServing
                                                          .Include(e => e.ShowCauseClarificationServingMode)
        ...
        public ActionResult Edit(int data)
        {
            using (DataBaseContext db = new DataBaseContext())
            {
                var returndata = db.FinalShowCauseNoticeClarificarionServing
                                .Include(e => e.ShowCauseClarificationServingMode)
                                .Include(e => e.ShowCauseClarificationServingMode.ChargeSheetServingModeName)
                                  .Where(e => e.Id == data)
                    .Select(e => new
                    {
                        ...
                        NoticeClarificationServingDate = e.NoticeClarificationServingDate,
                        Narration = e.Narration,
                        ShowCauseClarificationServingMode_Id = e.ShowCauseClarificationServingMode != null ? e.ShowCauseClarificationServingMode.Id : 0,
                        ShowCauseClarificationServingMode = e.ShowCauseClarificationServingMode.ChargeSheetServingModeName.LookupVal + "," + e.ShowCauseClarificationServingMode.ServingSeq == null ? "" : e.ShowCauseClarificationServingMode.ChargeSheetServingModeName.LookupVal + "," + e.ShowCauseClarificationServingMode.ServingSeq
                    }).ToList();

                List<returnEditclass> onreturnEditclass = new List<returnEditclass>();
                var k = db.FinalShowCauseNoticeClarificarionServing.Include(e => e.ShowCauseNotice)
                ...
                var m = db.FinalShowCauseNoticeClarificarionServing.Include(e => e.Witness).Include(e => e.Witness.Select(t => t.WitnessEmp))
        ...
        [HttpPost]
        public async Task<ActionResult> EditSave(FinalShowCauseNoticeClarificarionServing c, int data, FormCollection form) // Edit submit
        {
            using (DataBaseContext db = new DataBaseContext())
            {
                List<string> Msg = new List<string>();
                try
                {
                    ...
                    if (NoticeClarificationServingDate != null)
                    {
                        if (NoticeClarificationServingDate != "")
                        {
                    ...
                    if (ShowCauseClarificationServingMode != null)
                    {
                        if (ShowCauseClarificationServingMode != "")
                        {
                            var val = db.ChargeSheetServingMode.Find(int.Parse(ShowCauseClarificationServingMode));
                            c.ShowCauseClarificationServingMode = val;

                            var type = db.FinalShowCauseNoticeClarificarionServing.Include(e => e.ShowCauseClarificationServingMode).Where(e => e.Id == data).SingleOrDefault();
                            IList<FinalShowCauseNoticeClarificarionServing> typedetails = null;
                            if (type.ShowCauseClarificationServingMode != null)
                            {
                                typedetails = db.FinalShowCauseNoticeClarificarionServing.Where(x => x.ShowCauseClarificationServingMode.Id == type.ShowCauseClarificationServingMode.Id && x.Id == data).ToList();
                            }
                            else
                            {
                                typedetails = db.FinalShowCauseNoticeClarificarionServing.Where(x => x.Id == data).ToList();
                            }
                            //db.Entry(type).State = System.Data.Entity.EntityState.Detached;
                            foreach (var s in typedetails)
                            {
                                s.ShowCauseClarificationServingMode = c.ShowCauseClarificationServingMode;
                                db.FinalShowCauseNoticeClarificarionServing.Attach(s);
                    ...
                    {
                        var SrmdTypeDetails = db.FinalShowCauseNoticeClarificarionServing.Include(e => e.ShowCauseClarificationServingMode).Where(x => x.Id == data).ToList();
                        foreach (var s in SrmdTypeDetails)
                        {
                            s.ShowCauseClarificationServingMode = null;
                            db.FinalShowCauseNoticeClarificarionServing.Attach(s);
                            db.Entry(s).State = System.Data.Entity.EntityState.Modified;
                            //await db.SaveChangesAsync();
                            db.SaveChanges();
                    ...
                    var db_data = db.FinalShowCauseNoticeClarificarionServing.Include(e => e.Witness).Where(e => e.Id == data).SingleOrDefault();
                    ...
                    var db_data1 = db.FinalShowCauseNoticeClarificarionServing.Include(e => e.ShowCauseNotice).Where(e => e.Id == data).SingleOrDefault();
                    List<EmployeeDocuments> showcausenoticedoc = new List<EmployeeDocuments>();
                    if (ShowCauseNotice != null)
                    {
                        var ids = Utility.StringIdsToListIds(ShowCauseNotice);
                        foreach (var ca in ids)
                        {
                    ...
                    if (Auth == false)
                    {
                        ...
                        try
                        {
                            ...
                            using (TransactionScope ts = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
                            {
                                FinalShowCauseNoticeClarificarionServing blog = null; // to retrieve old data
                                DbPropertyValues originalBlogValues = null;

                                using (var context = new DataBaseContext())
                                {
                                    blog = context.FinalShowCauseNoticeClarificarionServing.Where(e => e.Id == data).SingleOrDefault();
                                ...
                                var m = db.FinalShowCauseNoticeClarificarionServing.Include(e => e.Witness).Where(e => e.Id == data).ToList();
                                foreach (var s in m)
                                {
                                ...
                                var m1 = db.FinalShowCauseNoticeClarificarionServing.Include(e => e.ShowCauseNotice).Where(e => e.Id == data).ToList();
                                foreach (var s in m1)
                                {
                                    // s.AppraisalPeriodCalendar = null;
                                    db.FinalShowCauseNoticeClarificarionServing.Attach(s);
                                ...
                                var CurCorp = db.FinalShowCauseNoticeClarificarionServing.Find(data);
                                TempData["CurrRowVersion"] = CurCorp.RowVersion;
                                db.Entry(CurCorp).State = System.Data.Entity.EntityState.Detached;
                                if (DBTrackFile.ByteArrayCompare((byte[])TempData["CurrRowVersion"], (byte[])TempData["RowVersion"]) == true)
                                {
                                    // c.DBTrack = dbT;
                                    FinalShowCauseNoticeClarificarionServing corp = new FinalShowCauseNoticeClarificarionServing()
                                    {
                                        NoticeClarificationServingDate = c.NoticeClarificationServingDate,
                                        IsClosedServing = c.IsClosedServing,
                                        IsNoticeRecd = c.IsNoticeRecd,
                                    ...
                                    db.FinalShowCauseNoticeClarificarionServing.Attach(corp);
                        ...
                        catch (DbUpdateConcurrencyException ex)
                        {
                            ...
                            var clientValues = (FinalShowCauseNoticeClarificarionServing)entry.Entity;
                            ...
                            {
                                var databaseValues = (FinalShowCauseNoticeClarificarionServing)databaseEntry.ToObject();
                    ...
                    else
                    {
                        using (TransactionScope ts = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
                        {
                            ...
                            db.FinalShowCauseNoticeClarificarionServing.Attach(blog);
