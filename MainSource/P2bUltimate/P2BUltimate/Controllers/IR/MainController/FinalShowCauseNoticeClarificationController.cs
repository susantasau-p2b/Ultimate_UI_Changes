...
{
    public class FinalShowCauseNoticeClarificationController : Controller
    {
        //
        // GET: /FinalShowCauseNoticeClarification/
        public ActionResult Index()
        {
            return View("~/Views/IR/MainViews/FinalShowCauseNoticeClarification/Index.cshtml");
        }
        public class P2BGridData
        {
            ...
            public string NoticeReplyClarificationDate { get; set; }
            public string ReplyClarificationDetails { get; set; }
        }
        ...
        [HttpPost]
        public ActionResult Create(FinalShowCauseNoticeClarification c, FormCollection form, string EmpIr)
        {
            ...
            using (DataBaseContext db = new DataBaseContext())
            {
                try
                {
                    ...
                    string NoticeReplyClarificationDate = form["NoticeReplyClarificationDate"] == "0" ? "" : form["NoticeReplyClarificationDate"];
                    string caseNO = Convert.ToString(Session["findcase"]);
                    if (NoticeReplyClarificationDate != null && NoticeReplyClarificationDate != "")
                    {
                        var val = DateTime.Parse(NoticeReplyClarificationDate);
                        c.NoticeReplyClarificationDate = val;
                    }
                    string showCauseDoc = form["ShowCauseNoticeList"] == "0" ? null : form["ShowCauseNoticeList"];
                    if (showCauseDoc != null && showCauseDoc != "")
                    {
                        ...
                        foreach (var ca in ids)
                        {
                            ...
                            showcausenotice.Add(Showcausenoticedoc_val);
                    ...
                    if (ModelState.IsValid)
                    {
                        using (TransactionScope ts = new TransactionScope())
                        {
                            ...
                            #region Already FinalShowCauseNoticeClarification enquiry records exist checking code
                            var EMPIR = db.EmployeeIR.Select(s => new
                            {
                                ...
                                EDP = s.EmpDisciplineProcedings.Select(r => new
                                {
                                    EDPid = r.Id,
                                    CaseNum = r.CaseNo,
                                    FSNC = r.FinalShowCauseNoticeClarification,
                            ...
                            if (EMPIR != null)
                            {
                                ...
                                foreach (var itemC in chkEMPIR.Where(e => e.FSNC != null))
                                {
                                    if (itemC.EDPid != 0 && itemC.CaseNum != null && itemC.FSNC != null)
                                    {
                            ...
                            FinalShowCauseNoticeClarification FinalShowCauseNoticeClarification = new FinalShowCauseNoticeClarification()
                            {

                                Narration = c.Narration,
                                ReplyClarificationDetails = c.ReplyClarificationDetails,
                                NoticeReplyClarificationDate = c.NoticeReplyClarificationDate,
                                ShowCauseNotice=c.ShowCauseNotice,
                                DBTrack = c.DBTrack
                            };
                            var FinalShowCauseNoticeReplyValidation = ValidateObj(FinalShowCauseNoticeClarification);
                            if (FinalShowCauseNoticeReplyValidation.Count > 0)
                            {
                                foreach (var item in FinalShowCauseNoticeReplyValidation)
                                {

                                    Msg.Add("FinalShowCauseNoticeReply" + item);
                                }
                                return Json(new Utility.JsonReturnClass { success = false, responseText = Msg }, JsonRequestBehavior.AllowGet);
                            }
                            db.FinalShowCauseNoticeClarification.Add(FinalShowCauseNoticeClarification);
                            ...
                            try
                            {
                                ...
                                //    .Include(e => e.FinalShowCauseNoticeServing).Include(e => e.FinalShowCauseNoticeReply)
                                ...
                                EmpDisciplineProcedings EmpDiscipline = new EmpDisciplineProcedings()
                                {
                                    ...
                                    FinalShowCauseNoticeClarification = db.FinalShowCauseNoticeClarification.Find(FinalShowCauseNoticeClarification.Id),
                                    DBTrack = c.DBTrack
                                };
        ...
        public ActionResult P2BGrid(P2BGrid_Parameters gp)
        {
            try
            {
                ...
                IEnumerable<P2BGridData> FinalShowCauseNoticeClarification = null;
                List<P2BGridData> model = new List<P2BGridData>();
                P2BGridData view = null;
                //var oemployeedata = db.FinalShowCauseNoticeClarification.OrderBy(e => e.Id).ToList();
                ...
                var oemployeedata = db.EmployeeIR.Select(a => new
                {
                    ...
                    oEmpDiscipline = a.EmpDisciplineProcedings.Select(b => new
                    {
                        ...
                        oNoticeReplyClarificationDate = b.FinalShowCauseNoticeClarification.NoticeReplyClarificationDate,
                        oReplyClarificationDetails = b.FinalShowCauseNoticeClarification.ReplyClarificationDetails,

                        oNarration = b.FinalShowCauseNoticeClarification.Narration,
                        oId = b.FinalShowCauseNoticeClarification.Id.ToString(),
                ...
                {
                    foreach (var item in itemIR.oEmpDiscipline.Where(e => e.oProceedStage == "15").OrderBy(o => o.oCaseNo))
                    {
                        view = new P2BGridData()
                        {
                            ...
                            NoticeReplyClarificationDate = item.oNoticeReplyClarificationDate != null ? item.oNoticeReplyClarificationDate.Value.ToString("dd/MM/yyyy") : "",
                            Id = item.oId.ToString(),
                            ReplyClarificationDetails = item.oReplyClarificationDetails.ToString(),
                ...
                FinalShowCauseNoticeClarification = model;

                IEnumerable<P2BGridData> IE;
                if (!string.IsNullOrEmpty(gp.searchField))
                {
                    IE = FinalShowCauseNoticeClarification;
                        ...
                        jsonData = IE
                         .Where((e => (e.Narration.ToString().ToUpper().Contains(gp.searchString))
                            || (e.CaseNo.ToString().Contains(gp.searchString))
                                    ...
                                    || (e.ReplyClarificationDetails.ToString().Contains(gp.searchString.ToUpper()))
                                   || (e.NoticeReplyClarificationDate.ToString().Contains(gp.searchString.ToUpper()))



                                  || (e.Id.ToString().Contains(gp.searchString))
                                 )).ToList()
                        .Select(a => new Object[] { a.CaseNo, a.VictimName, a.ProceedingStage, a.NoticeReplyClarificationDate, a.ReplyClarificationDetails, a.Narration, a.Id });
                    }
                    if (pageIndex > 1)
                    {
                        int h = pageIndex * pageSize;
                        jsonData = IE.Skip(pageIndex).Take(pageSize).Select(a => new Object[] { a.CaseNo, a.VictimName, a.ProceedingStage, a.NoticeReplyClarificationDate, a.ReplyClarificationDetails, a.Narration, a.Id }).ToList();
                    }
                ...
                else
                {
                    ...
                    {
                        orderfuc = (c => gp.sidx == "NoticeReplyClarificationDate" ? c.NoticeReplyClarificationDate.ToString() :
                            gp.sidx == "CaseNo" ? c.CaseNo.ToString() :
                                        ...
                                        gp.sidx == "ReplyClarificationDetails" ? c.ReplyClarificationDetails.ToString() :
                    ...
                    if (gp.sord == "asc")
                    {
                        ...
                        jsonData = IE.Select(a => new Object[] { a.CaseNo, a.VictimName, a.ProceedingStage, Convert.ToString(a.NoticeReplyClarificationDate), a.ReplyClarificationDetails, a.Narration, a.Id }).ToList();
                    }
                    else if (gp.sord == "desc")
                    {
                        IE = IE.OrderByDescending(orderfuc);
                        jsonData = IE.Select(a => new Object[] { a.CaseNo, a.VictimName, a.ProceedingStage, a.NoticeReplyClarificationDate, a.ReplyClarificationDetails, a.Narration, a.Id }).ToList();
                    }
                    if (pageIndex > 1)
                    {
                        int h = pageIndex * pageSize;
                    ...
                    totalRecords = FinalShowCauseNoticeClarification.Count();
                }
                if (totalRecords > 0)
                {
        ...
        public async Task<ActionResult> Delete(int data)
        {
            ...
            using (DataBaseContext db = new DataBaseContext())
            {
                try
                {
                    FinalShowCauseNoticeClarification corporates = db.FinalShowCauseNoticeClarification
        ...
        public ActionResult Edit(int data)
        {
            using (DataBaseContext db = new DataBaseContext())
            {
                var returndata = db.FinalShowCauseNoticeClarification
                                  .Where(e => e.Id == data).AsEnumerable()
                    .Select(e => new
                    {
                        ReplyClarificationDetails = e.ReplyClarificationDetails,
                        NoticeReplyClarificationDate = e.NoticeReplyClarificationDate,
                        Narration = e.Narration,
                    }).ToList();

                List<returnEditClass> oreturnEditClass = new List<returnEditClass>();
                var k = db.FinalShowCauseNoticeClarification.Include(e => e.ShowCauseNotice)
                   .Include(e => e.ShowCauseNotice.Select(a => a.DocumentType))
                  .Where(e => e.Id == data && e.ShowCauseNotice.Count > 0).ToList();
                foreach (var e in k)
                {
                    oreturnEditClass.Add(new returnEditClass
                    {
                        Employeedoc_Id = e.ShowCauseNotice.Select(a => a.Id.ToString()).ToArray(),
                        EmployeedocFullDetails = e.ShowCauseNotice.Select(a => a.FullDetails).ToArray()
                    });
                }
        ...
        [HttpPost]
        public async Task<ActionResult> EditSave(FinalShowCauseNoticeClarification c, int data, FormCollection form) // Edit submit
        {
            using (DataBaseContext db = new DataBaseContext())
            {
                List<string> Msg = new List<string>();
                try
                {
                    ...
                    if (NoticeReplyClarificationDate != null)
                    {
                        if (NoticeReplyClarificationDate != "")
                        {
                    ...
                    var db_data = db.FinalShowCauseNoticeClarification.Include(e => e.ShowCauseNotice).Where(e => e.Id == data).SingleOrDefault();
                    ...
                    if (showCauseDoc != null)
                    {
                        ...
                        foreach (var ca in ids)
                        {
                            ...
                            db_data.ShowCauseNotice = employeedoc;
                        }
                    }
                    else
                    {
                    ...
                    if (Auth == false)
                    {
                        if (ModelState.IsValid)
                        {
                            try
                            {
                                ...
                                using (TransactionScope ts = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
                                {
                                    FinalShowCauseNoticeClarification blog = null; // to retrieve old data
                                    DbPropertyValues originalBlogValues = null;

                                    using (var context = new DataBaseContext())
                                    {
                                        blog = context.FinalShowCauseNoticeClarification.Where(e => e.Id == data).SingleOrDefault();
                                    ...
                                    var m1 = db.FinalShowCauseNoticeClarification.Include(e =>e.ShowCauseNotice).Where(e => e.Id == data).ToList();
                                    foreach (var s in m1)
                                    {
                                        // s.AppraisalPeriodCalendar = null;
                                        db.FinalShowCauseNoticeClarification.Attach(s);
                                    ...
                                    var CurCorp = db.FinalShowCauseNoticeClarification.Find(data);
                                    TempData["CurrRowVersion"] = CurCorp.RowVersion;
                                    db.Entry(CurCorp).State = System.Data.Entity.EntityState.Detached;
                                    if (DBTrackFile.ByteArrayCompare((byte[])TempData["CurrRowVersion"], (byte[])TempData["RowVersion"]) == true)
                                    {
                                        // c.DBTrack = dbT;
                                        FinalShowCauseNoticeClarification corp = new FinalShowCauseNoticeClarification()
                                        {
                                        ...
                                        db.FinalShowCauseNoticeClarification.Attach(corp);
                            ...
                            catch (DbUpdateConcurrencyException ex)
                            {
                                ...
                                var clientValues = (FinalShowCauseNoticeClarification)entry.Entity;
                                ...
                                {
                                    var databaseValues = (FinalShowCauseNoticeClarification)databaseEntry.ToObject();
                    ...
                    else
                    {
                        using (TransactionScope ts = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
                        {
                            ...
                            db.FinalShowCauseNoticeClarification.Attach(blog);
