...
{
    public class FinalShowCauseNoticeReplyController : Controller
    {
        //
        // GET: /FinalShowCauseNoticeReply/
        public ActionResult Index()
        {
            return View("~/Views/IR/MainViews/FinalShowCauseNoticeReply/Index.cshtml");
        }
        ...
        public class P2BGridData
        {
            ...
            public string NoticeReplyRecdDate { get; set; }
            public string IsReplyStudied { get; set; }
        ...
        [HttpPost]
        public ActionResult Create(FinalShowCauseNoticeReply c, FormCollection form, string EmpIr)
        {
            ...
            using (DataBaseContext db = new DataBaseContext())
            {
                try
                {
                    ...
                    string NoticeReplyRecdDate = form["NoticeReplyRecdDate"] == "0" ? "" : form["NoticeReplyRecdDate"];
                    if (NoticeReplyRecdDate != null && NoticeReplyRecdDate != "")
                    {
                        var val = DateTime.Parse(NoticeReplyRecdDate);
                        c.NoticeReplyRecdDate = val;
                    }
                    ...
                    if (showCauseDoc != null && showCauseDoc != "")
                    {
                        ...
                        foreach (var ca in ids)
                        {
                            ...
                            showcausedoc.Add(EmployeeDocuments_val);
                            c.ShowCauseNotice = showcausedoc;
                        }
                    }
                    else
                    ...
                    if (ModelState.IsValid)
                    {
                        using (TransactionScope ts = new TransactionScope())
                        {
                            ...
                            #region Already FinalShowCauseNoticeReply enquiry records exist checking code
                            var EMPIR = db.EmployeeIR.Select(s => new
                            {
                                ...
                                EDP = s.EmpDisciplineProcedings.Select(r => new
                                {
                                    EDPid = r.Id,
                                    CaseNum = r.CaseNo,
                                    FSNR = r.FinalShowCauseNoticeReply,
                            ...
                            if (EMPIR != null)
                            {
                                ...
                                foreach (var itemC in chkEMPIR.Where(e => e.FSNR != null))
                                {
                                    if (itemC.EDPid != 0 && itemC.CaseNum != null && itemC.FSNR != null)
                                    {
                            ...
                            FinalShowCauseNoticeReply FinalShowCauseNoticeReply = new FinalShowCauseNoticeReply()
                            {

                                ReplyDetails = c.ReplyDetails,
                                NoticeReplyRecdDate = c.NoticeReplyRecdDate,
                                IsReplyStudied = c.IsReplyStudied,
                                ShowCauseNotice = c.ShowCauseNotice,
                                DBTrack = c.DBTrack
                            };
                            var FinalShowCauseNoticeReplyValidation = ValidateObj(FinalShowCauseNoticeReply);
                            ...
                            db.FinalShowCauseNoticeReply.Add(FinalShowCauseNoticeReply);
                            ...
                            try
                            {
                                ...
                                EmpDisciplineProcedings EmpDiscipline = new EmpDisciplineProcedings()
                                {
                                    ...
                                    FinalShowCauseNoticeReply = db.FinalShowCauseNoticeReply.Find(FinalShowCauseNoticeReply.Id),
                                    DBTrack = c.DBTrack
                                };
        ...
        public ActionResult P2BGrid(P2BGrid_Parameters gp)
        {
            try
            {
                ...
                IEnumerable<P2BGridData> FinalShowCauseNoticeReply = null;
                List<P2BGridData> model = new List<P2BGridData>();
                P2BGridData view = null;
                //var oemployeedata = db.FinalShowCauseNoticeReply.OrderBy(e => e.Id).ToList();
                var oemployeedata = db.EmployeeIR.Select(a => new
                {
                    ...
                    oEmpDiscipline = a.EmpDisciplineProcedings.Select(b => new
                    {
                        ...
                        oNoticeReplyRecdDate = b.FinalShowCauseNoticeReply.NoticeReplyRecdDate,
                        oReplyDetails = b.FinalShowCauseNoticeReply.ReplyDetails,
                        oIsReplyStudied = b.FinalShowCauseNoticeReply.IsReplyStudied.ToString(),

                        oId = b.FinalShowCauseNoticeReply.Id.ToString(),
                ...
                {
                    foreach (var item in itemIR.oEmpDiscipline.Where(e => e.oProceedStage == "14").OrderBy(o => o.oCaseNo))
                    {
                        view = new P2BGridData()
                        {
                            ...
                            NoticeReplyRecdDate = item.oNoticeReplyRecdDate.Value.ToString("dd/MM/yyyy"),
                            Id = item.oId.ToString(),
                            ReplyDetails = item.oReplyDetails.ToString(),
                            IsReplyStudied = item.oIsReplyStudied.ToString(),
                        };
                ...
                FinalShowCauseNoticeReply = model;

                IEnumerable<P2BGridData> IE;

                if (!string.IsNullOrEmpty(gp.searchField))
                {
                    IE = FinalShowCauseNoticeReply;
                    if (gp.searchOper.Equals("eq"))
                    {
                        jsonData = IE
                         .Where((e => (e.CaseNo.ToString().Contains(gp.searchString))
                             ...
                             || (e.ReplyDetails.ToString().ToUpper().Contains(gp.searchString))

                                    || (e.NoticeReplyRecdDate.ToString().Contains(gp.searchString.ToUpper()))
                                   || (e.IsReplyStudied.ToString().Contains(gp.searchString.ToUpper()))



                                  || (e.Id.ToString().Contains(gp.searchString))
                                 )).ToList()
                        .Select(a => new Object[] { a.CaseNo, a.VictimName, a.ProceedingStage, a.ReplyDetails, a.NoticeReplyRecdDate, a.IsReplyStudied, a.Id });
                    }
                    if (pageIndex > 1)
                    {
                        int h = pageIndex * pageSize;
                        jsonData = IE.Skip(pageIndex).Take(pageSize).Select(a => new Object[] { a.CaseNo, a.VictimName, a.ProceedingStage, a.ReplyDetails, a.NoticeReplyRecdDate, a.IsReplyStudied, a.Id }).ToList();
                    }
                ...
                else
                {
                    ...
                    else
                    {
                        orderfuc = (c => gp.sidx == "CaseNo" ? c.CaseNo.ToString() :
                            ...
                            gp.sidx == "ReplyDetails" ? c.ReplyDetails.ToString() :

                                        gp.sidx == "NoticeReplyRecdDate" ? c.NoticeReplyRecdDate.ToString() :
                                        gp.sidx == "IsReplyStudied" ? c.IsReplyStudied.ToString() : "");

                    }
                    if (gp.sord == "asc")
                    {
                        IE = IE.OrderBy(orderfuc);
                        jsonData = IE.Select(a => new Object[] { a.CaseNo, a.VictimName, a.ProceedingStage, Convert.ToString(a.NoticeReplyRecdDate), a.ReplyDetails, a.IsReplyStudied, a.Id }).ToList();
                    }
                    else if (gp.sord == "desc")
                    {
                        IE = IE.OrderByDescending(orderfuc);
                        jsonData = IE.Select(a => new Object[] { a.CaseNo, a.VictimName, a.ProceedingStage, a.NoticeReplyRecdDate, a.ReplyDetails, a.IsReplyStudied, a.Id }).ToList();
                    }
                    if (pageIndex > 1)
                    {
                        int h = pageIndex * pageSize;
                        jsonData = IE.Skip(pageIndex).Take(pageSize).Select(a => new Object[] { a.CaseNo, a.VictimName, a.ProceedingStage, a.NoticeReplyRecdDate, a.ReplyDetails, a.IsReplyStudied, a.Id }).ToList();
                    }
                    totalRecords = FinalShowCauseNoticeReply.Count();
                }
                if (totalRecords > 0)
                {
        ...
        public async Task<ActionResult> Delete(int data)
        {
            ...
            using (DataBaseContext db = new DataBaseContext())
            {
                try
                {
                    FinalShowCauseNoticeReply corporates = db.FinalShowCauseNoticeReply
        ...
        {
            public Array Showcausenotice_Id { get; set; }
            public Array Sshowcausenoticefulldetails { get; set; }
        }
        public ActionResult Edit(int data)
        {
            using (DataBaseContext db = new DataBaseContext())
            {
                var returndata = db.FinalShowCauseNoticeReply
                                   .Include(e => e.ShowCauseNotice)
                                  .Where(e => e.Id == data).AsEnumerable()
                    .Select(e => new
                    {
                        ReplyDetails = e.ReplyDetails,
                        NoticeReplyRecdDate = e.NoticeReplyRecdDate,
                        IsReplyStudied = e.IsReplyStudied,
                    }).ToList();
                List<returnEditclass> onreturnEditclass = new List<returnEditclass>();
                var k = db.FinalShowCauseNoticeReply.Include(e => e.ShowCauseNotice)
                ...
                foreach (var e in k)
                {
                    ...
                    {
                        Showcausenotice_Id = e.ShowCauseNotice.Select(a => a.Id.ToString()).ToArray(),
                        Sshowcausenoticefulldetails = e.ShowCauseNotice.Select(a => a.FullDetails).ToArray()
                    });
                }
        ...
        [HttpPost]
        public async Task<ActionResult> EditSave(FinalShowCauseNoticeReply c, int data, FormCollection form) // Edit submit
        {
            using (DataBaseContext db = new DataBaseContext())
            {
                List<string> Msg = new List<string>();
                try
                {
                    ...
                    if (NoticeReplyRecdDate != null)
                    {
                        if (NoticeReplyRecdDate != "")
                        {
                    ...
                    var db_data = db.FinalShowCauseNoticeReply.Include(e => e.ShowCauseNotice).Where(e => e.Id == data).SingleOrDefault();
                    ...
                    if (showCauseDoc != null)
                    {
                        ...
                        foreach (var ca in ids)
                        {
                            ...
                            db_data.ShowCauseNotice = showcausenoticelist;
                        }
                    }
                    else
                    {
                    ...
                    if (Auth == false)
                    {
                        if (ModelState.IsValid)
                        {
                            try
                            {
                                ...
                                using (TransactionScope ts = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
                                {
                                    FinalShowCauseNoticeReply blog = null; // to retrieve old data
                                    DbPropertyValues originalBlogValues = null;

                                    using (var context = new DataBaseContext())
                                    {
                                        blog = context.FinalShowCauseNoticeReply.Where(e => e.Id == data).SingleOrDefault();
                                    ...
                                    var m1 = db.FinalShowCauseNoticeReply.Include(e => e.ShowCauseNotice).Where(e => e.Id == data).ToList();
                                    foreach (var s in m1)
                                    {
                                        // s.AppraisalPeriodCalendar = null;
                                        db.FinalShowCauseNoticeReply.Attach(s);
                                    ...
                                    var CurCorp = db.FinalShowCauseNoticeReply.Find(data);
                                    TempData["CurrRowVersion"] = CurCorp.RowVersion;
                                    db.Entry(CurCorp).State = System.Data.Entity.EntityState.Detached;
                                    if (DBTrackFile.ByteArrayCompare((byte[])TempData["CurrRowVersion"], (byte[])TempData["RowVersion"]) == true)
                                    {
                                        // c.DBTrack = dbT;
                                        FinalShowCauseNoticeReply corp = new FinalShowCauseNoticeReply()
                                        {
                                            ReplyDetails = c.ReplyDetails,
                                            NoticeReplyRecdDate = c.NoticeReplyRecdDate,
                                            IsReplyStudied = c.IsReplyStudied,
                                        ...
                                        db.FinalShowCauseNoticeReply.Attach(corp);
                            ...
                            catch (DbUpdateConcurrencyException ex)
                            {
                                ...
                                var clientValues = (FinalShowCauseNoticeReply)entry.Entity;
                                ...
                                {
                                    var databaseValues = (FinalShowCauseNoticeReply)databaseEntry.ToObject();
                    ...
                    else
                    {
                        using (TransactionScope ts = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
                        {
                            ...
                            db.FinalShowCauseNoticeReply.Attach(blog);
