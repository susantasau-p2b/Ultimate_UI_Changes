...
{
    public class LvConvertPolicyController : Controller
    {
        //
        // GET: /LvSharingPolicy/
        ...
        [HttpPost]
        public ActionResult Create(LvConvertPolicy L, FormCollection form)
        {
            using (DataBaseContext db = new DataBaseContext())
            {
                ...
                try
                {
                    ...
                    string LvConvert = form["LvConvert_drop"] == "0" ? "" : form["LvConvert_drop"];
                    var lvhC = Convert.ToInt32(LvConvert);
                    //if (db.LvConvertPolicy.Any(e => e.LvHead.Id == lvh))
                    //{
                    ...
                    if (LvConvert != null && LvConvert != "")
                    {
                      
                        var value = db.LookupValue.Find(int.Parse(LvConvert));
                        L.LvConvert = value;
                    }
                    ...
                    if (ModelState.IsValid)
                    {
                        using (TransactionScope ts = new TransactionScope())
                        {
                            ...
                            LvConvertPolicy OBJLVDP = new LvConvertPolicy()
                            {
                            ...
                            try
                            {
                                db.LvConvertPolicy.Add(OBJLVDP);
        ...
        { 
            using (DataBaseContext db = new DataBaseContext())
            {
                var Q = db.LvConvertPolicy
                    .Include(e=>e.LvConvert)
                    .Where(e => e.Id == data).Select
                    (e => new
                    {
                        LvHead_Id = e.LvHead_Id,
                        LvConvert_Id = e.LvConvert_Id,
                        Action = e.DBTrack.Action
                    }).ToList();


                var Corp = db.LvConvertPolicy.Find(data);
        ...
        public async Task<ActionResult> EditSave(LvConvertPolicy ESOBJ, int data, FormCollection form)
        {
            List<string> Msg = new List<string>();
            ...
            ESOBJ.LvConvert_Id = LvConvert != null && LvConvert != "" ? int.Parse(LvConvert) : 0;
            ...
            using (DataBaseContext db = new DataBaseContext())
            {
                try
                {
                    using (TransactionScope ts = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
                    {
                        ...
                        LvConvertPolicy SharingPol = db.LvConvertPolicy.Find(data);
                        ...
                        if (DBTrackFile.ByteArrayCompare((byte[])TempData["CurrRowVersion"], (byte[])TempData["RowVersion"]) == true)
                        {
                            ...
                            SharingPol.LvConvert_Id = ESOBJ.LvConvert_Id;
