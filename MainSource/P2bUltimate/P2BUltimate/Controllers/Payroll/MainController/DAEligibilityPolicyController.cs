...
{
    public class DAEligibilityPolicyController : Controller
    {
        //
        // GET: /DAEligibilityPolicy/
        public ActionResult Index()
        {
            return View("~/Views/Payroll/MainViews/DAEligibilityPolicy/Index.cshtml");
        }
        [HttpPost]
        ...
        public ActionResult Create(DAEligibilityPolicy c, FormCollection form) //Create submit
        {
            using (DataBaseContext db = new DataBaseContext())
            {
               ...
               // string travelModeEligibilityPolicyList = form["TravelModeEligibilityPolicyList"] == "0" ? "" : form["TravelModeEligibilityPolicyList"];
                ...
                try
                {
                    ...
                    //    if (WagesRange != "")
                    //    {
                    //        int AddId = Convert.ToInt32(WagesRange);
                    //        var val = db.SlabDependRule//.Include(e => e.Area)
                    //            //.Include(e => e.City)
                    //            //.Include(e => e.Country)
                    ...
                    //        c.SlabDependRule = val;
                    //    }
                    //}

                    if (WagesRange != "" && WagesRange != null)
                    {
                        ...
                        c.SlabDependRule = SlabDependRule;

                        db.SlabDependRule.Add(SlabDependRule);
                    }
                    else
                    {
                        c.SlabDependRule = null;
                    }
                    ...
                    if (ModelState.IsValid)
                    {
                        using (TransactionScope ts = new TransactionScope())
                        {
                            ...
                            DAEligibilityPolicy DAEligibilityPolicy = new DAEligibilityPolicy()
                            {
                                TA_DA_Eligibilty_Code = c.TA_DA_Eligibilty_Code,
                                TA_DA_Eligibility_Wages = c.TA_DA_Eligibility_Wages,
                                SlabDependRule = c.SlabDependRule,

                                DBTrack = c.DBTrack
                            };

                            db.DAEligibilityPolicy.Add(DAEligibilityPolicy);
                            db.SaveChanges();
                            ts.Complete();
        ...
        public ActionResult Edit(int data)
        {
            ...
            using (DataBaseContext db = new DataBaseContext())
            {
                var Q = db.DAEligibilityPolicy
                    .Include(e => e.SlabDependRule)
                    .Include(e => e.SlabDependRule.WageRange)
                    
                    .Include(e => e.TA_DA_Eligibility_Wages)

                    .Where(e => e.Id == data).Select
                    (e => new
                    {
                        Code = e.TA_DA_Eligibilty_Code,
                        Wages_id = e.TA_DA_Eligibility_Wages == null ? 0 : e.TA_DA_Eligibility_Wages.Id,
                        Wages_Fulldetails = e.TA_DA_Eligibility_Wages == null ? "" : e.TA_DA_Eligibility_Wages.FullDetails,
                      
                    }).ToList();

                List<returnEditClass> oreturnEditClass = new List<returnEditClass>();

                var k = db.DAEligibilityPolicy.Include(e => e.SlabDependRule)
             .Include(e => e.SlabDependRule.WageRange)

                 .Where(e => e.Id == data ).ToList();
                foreach (var e in k)
                {
                    if (e.SlabDependRule.WageRange!=null)
                    {
                        oreturnEditClass.Add(new returnEditClass
                        {
                            WagesRange_Id = e.SlabDependRule.WageRange.Select(a => a.Id.ToString()).ToArray(),
                            WagesRangeFullDetails = e.SlabDependRule.WageRange.Select(a => a.FullDetails).ToArray()
                        });  
                    }
                   
                }
                //var add_data = db.DAEligibilityPolicy
                ...
                var Corp = db.DAEligibilityPolicy.Find(data);
                TempData["RowVersion"] = Corp.RowVersion;
                var Auth = Corp.DBTrack.IsModified;
                return Json(new Object[] { Q, oreturnEditClass, Auth, JsonRequestBehavior.AllowGet });
            }
        }
        public async Task<ActionResult> EditSave(DAEligibilityPolicy c, int data, FormCollection form)
        {
            using (DataBaseContext db = new DataBaseContext())
            {
                List<string> Msg = new List<string>();
                ...
                {
                    c.TA_DA_Eligibility_Wages_Id = Convert.ToInt32(TaEligibilitywages);
                }
                else
                {
                    c.TA_DA_Eligibility_Wages_Id = null;
                }
                //if (wagesrangelist != null && wagesrangelist != "")
                //{
                //    c.SlabDependRule_Id = Convert.ToInt32(wagesrangelist);
                //}
                //else
                //{
                //    c.SlabDependRule_Id = null;
                //}
                if (TaEligibilitywages != null)
                {
                    if (TaEligibilitywages != "")
                    {
                        ...
                        var add = db.DAEligibilityPolicy.Include(e => e.TA_DA_Eligibility_Wages).Where(e => e.Id == data).SingleOrDefault();
                        IList<DAEligibilityPolicy> addressdetails = null;
                        if (add.TA_DA_Eligibility_Wages != null)
                        {
                            addressdetails = db.DAEligibilityPolicy.Where(x => x.TA_DA_Eligibility_Wages.Id == add.TA_DA_Eligibility_Wages.Id && x.Id == data).ToList();
                        }
                        else
                        {
                            addressdetails = db.DAEligibilityPolicy.Where(x => x.Id == data).ToList();
                        }
                        if (addressdetails != null)
                        {
                            foreach (var s in addressdetails)
                            {
                                s.TA_DA_Eligibility_Wages = c.TA_DA_Eligibility_Wages;
                                db.DAEligibilityPolicy.Attach(s);
                ...
                {
                    var addressdetails = db.DAEligibilityPolicy.Include(e => e.TA_DA_Eligibility_Wages).Where(x => x.Id == data).ToList();
                    foreach (var s in addressdetails)
                    {
                        s.TA_DA_Eligibility_Wages = null;
                        db.DAEligibilityPolicy.Attach(s);
                        db.Entry(s).State = System.Data.Entity.EntityState.Modified;
                ...
                DAEligibilityPolicy blog1 = null;
                using (var context = new DataBaseContext())
                {
                    blog1 = context.DAEligibilityPolicy.Where(e => e.Id == data).SingleOrDefault();
                }
                ...
                if (wagesrangelist != null)
                {
                    if (wagesrangelist != "")
                    {
                        ...
                        List<WagesRange> WagesRangeVal = new List<WagesRange>();
                        SlabDependRule SlabDependRuleNew = db.DAEligibilityPolicy.Include(e => e.SlabDependRule)
                        ...
                        else
                        {
                            ...
                            db.SaveChanges();
                            c.SlabDependRule = SlabDependRuleNew;
                        }

                    }
                    else
                    {
                        var BusiTypeDetails = db.DAEligibilityPolicy.Include(e => e.SlabDependRule).Where(x => x.Id == data).ToList();
                        foreach (var s in BusiTypeDetails)
                        {
                            s.SlabDependRule = null;
                            db.DAEligibilityPolicy.Attach(s);
                            db.Entry(s).State = System.Data.Entity.EntityState.Modified;
                            //await db.SaveChangesAsync();
                            db.SaveChanges();
                ...
                if (Auth == false)
                {
                    ...
                    if (ModelState.IsValid)
                    {
                        try
                        {
                            ...
                            {
                                DAEligibilityPolicy blog = null; // to retrieve old data
                                DbPropertyValues originalBlogValues = null;

                                using (var context = new DataBaseContext())
                                {
                                    blog = context.DAEligibilityPolicy.Where(e => e.Id == data)
                                                            .Include(e => e.TA_DA_Eligibility_Wages).Include(e => e.SlabDependRule)
                                                           .SingleOrDefault();
                                ...
                                var m1 = db.DAEligibilityPolicy.Where(e => e.Id == data).ToList();
                                foreach (var s in m1)
                                {
                                ...
                                var CurCorp = db.DAEligibilityPolicy.Find(data);
                                TempData["CurrRowVersion"] = CurCorp.RowVersion;
                                db.Entry(CurCorp).State = System.Data.Entity.EntityState.Detached;
                                if (DBTrackFile.ByteArrayCompare((byte[])TempData["CurrRowVersion"], (byte[])TempData["RowVersion"]) == true)
                                {
                                    // c.DBTrack = dbT;
                                    DAEligibilityPolicy corp = new DAEligibilityPolicy()
                                    {
                                        //LocationObj.LocCode = c.LocationObj.LocCode,
                                        //LocationObj.LocDesc = c.LocationObj.LocDesc,
                                        TA_DA_Eligibilty_Code = c.TA_DA_Eligibilty_Code,
                                        TA_DA_Eligibility_Wages = c.TA_DA_Eligibility_Wages,
                                        TA_DA_Eligibility_Wages_Id = c.TA_DA_Eligibility_Wages_Id,
                                       // SlabDependRule = c.SlabDependRule,
                                        SlabDependRule_Id = c.SlabDependRule.Id,
                                    ...
                                    db.DAEligibilityPolicy.Attach(corp);
                                    ...
                                    return Json(new Utility.JsonReturnClass { Id = corp.Id, Val = corp.TA_DA_Eligibilty_Code, success = true, responseText = Msg }, JsonRequestBehavior.AllowGet);
        ...
        public ActionResult Delete(int data)
        {
            using (DataBaseContext db = new DataBaseContext())
            {
                ...
                DAEligibilityPolicy DAEligibilityPolicy = db.DAEligibilityPolicy.Find(data);
                try
                {
                    using (TransactionScope ts = new TransactionScope())
                    {
                        db.Entry(DAEligibilityPolicy).State = System.Data.Entity.EntityState.Deleted;
                        db.SaveChanges();
                        ts.Complete();
                    }
        ...
        public ActionResult P2BGrid(P2BGrid_Parameters gp)
        {
            try
            {
                ...
                var DAEligibilityPolicy = new List<DAEligibilityPolicy>();
                DAEligibilityPolicy = db.DAEligibilityPolicy
                                      .Include(e => e.SlabDependRule)
                                      .Include(e => e.TA_DA_Eligibility_Wages)
                                      .ToList();
                IEnumerable<DAEligibilityPolicy> IE;
                if (!string.IsNullOrEmpty(gp.searchField))
                {
                    IE = DAEligibilityPolicy;
                    if (gp.searchOper.Equals("eq"))
                    {
                        jsonData = IE
                            .Where((e => (e.TA_DA_Eligibilty_Code.ToString().Contains(gp.searchString))
                               
                                || (e.TA_DA_Eligibility_Wages == null ? false : e.TA_DA_Eligibility_Wages.FullDetails.ToString().Contains(gp.searchString))
                                || (e.Id.ToString().Contains(gp.searchString))
                               )).ToList()
                               .Select(a => new Object[] { a.TA_DA_Eligibilty_Code, a.TA_DA_Eligibility_Wages == null ? "" : a.TA_DA_Eligibility_Wages.FullDetails.ToString(), a.Id });
                    ...
                    if (pageIndex > 1)
                    {
                        ...
                        jsonData = IE.Skip(pageIndex).Take(pageSize).Select(a => new Object[] { a.TA_DA_Eligibilty_Code, a.TA_DA_Eligibility_Wages == null ? "" : a.TA_DA_Eligibility_Wages.FullDetails.ToString(), a.Id }).ToList();
                ...
                {
                    IE = DAEligibilityPolicy;
                    Func<DAEligibilityPolicy, dynamic> orderfuc;
                    if (gp.sidx == "Id")
                    {
                    ...
                    {
                        orderfuc = (c => gp.sidx == "TA_TC_Elligibilty_Code" ? c.TA_DA_Eligibilty_Code :
                                        
                                         gp.sidx == "TA_Elligibility_Wages" ? c.TA_DA_Eligibility_Wages == null ? "" : c.TA_DA_Eligibility_Wages.FullDetails.ToString() : "");
                    }
                    if (gp.sord == "asc")
                    {
                        IE = IE.OrderBy(orderfuc);
                        jsonData = IE.Select(a => new Object[] { a.TA_DA_Eligibilty_Code, a.TA_DA_Eligibility_Wages == null ? "" : a.TA_DA_Eligibility_Wages.FullDetails.ToString(), a.Id }).ToList();
                    }
                    ...
                    totalRecords = DAEligibilityPolicy.Count();
                }
                if (totalRecords > 0)
                {
