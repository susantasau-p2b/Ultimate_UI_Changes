...
{
    [AuthoriseManger]
    public class EmployeePolicyStructController : Controller
    {
        // private DataBaseContext db = new DataBaseContext();
        public ActionResult Index()
        {
            return View("~/Views/Payroll/MainViews/EmployeePolicyStruct/Index.cshtml");
        }
        ...
        public ActionResult GetLookupLvstructdetails(List<int> SkipIds)
        {
            ...
            {
                var fall = db.EmployeePolicyStructDetails.Include(e => e.PolicyName).ToList();
                ...
                if (SkipIds != null)
                {
                    ...
                    {
                        if (fall == null)
                            fall = db.EmployeePolicyStructDetails.Where(e => !e.Id.ToString().Contains(a.ToString())).ToList();
                        else
        ...
        {
            return View("~/Views/Shared/Payroll/_EmployeePolicyStructDetails.cshtml");
        }
        ...
        [HttpPost]
        public ActionResult Create(EmployeePolicyStruct EmployeePolicyStruct, FormCollection form, String forwarddata) //Create submit
        {
                    ...
                    foreach (var i in ids)
                    {
                        ...
                        using (TransactionScope ts = new TransactionScope())
                        {
                            try
                            {
                                ...
                                ServiceBook.EmployeePolicyStructCreationTest(OEmployeePayroll, i, OPayScalAgreement.Id, Convert.ToDateTime(EmployeePolicyStruct.EffectiveDate), CompanyPayroll_Id.Id);
        ...
        public JsonResult GetPayscaleagreement(string data)
        {
            using (DataBaseContext db = new DataBaseContext())
            {
                ...
                var a = db.EmployeePolicyStruct.Include(e => e.EmployeePolicyStructDetails).Include(e => e.EmployeePolicyStructDetails.Select(r => r.PolicyAssignment))
                    ...
                    .EmployeePolicyStructDetails.FirstOrDefault().PolicyAssignment.PayScaleAgreement;
                return Json(a, JsonRequestBehavior.AllowGet);
            }
        }
        public class EmployeePolicyStructEditDetails
        {
            public Array EmpPolicyStructDetails_Id { get; set; }
            public Array EmpPolicyStructDetails_FullDetails { get; set; }
        }
        ...
        public ActionResult P2BInlineGrid(P2BGrid_Parameters gp)
        {
            try
            {
                ...
                var OEmployeeSalStruct = db.EmployeePayroll.Where(e => e.Employee.Id == EmpId).Include(e => e.Employee).Include(e => e.EmployeePolicyStruct.Select(r => r.EmployeePolicyStructDetails))
                    
                                        .Include(e => e.EmployeePolicyStruct.Select(r => r.EmployeePolicyStructDetails.Select(t => t.PolicyAssignment)))
                                        .Include(e => e.EmployeePolicyStruct.Select(r => r.EmployeePolicyStructDetails.Select(t => t.PolicyAssignment.PolicyFormula)))
                                        .Include(e => e.EmployeePolicyStruct.Select(r => r.EmployeePolicyStructDetails.Select(t => t.PolicyAssignment.PolicyName)))
                ...
                var OEmpSalStruct = OEmployeeSalStruct.EmployeePolicyStruct.Where(e => e.Id == id);

                foreach (var x in OEmpSalStruct)
                {

                    var OEmpSalStructDet = x.EmployeePolicyStructDetails;
                    foreach (var SalForAppl in OEmpSalStructDet)
                    {
                        var m = db.EmployeePolicyStructDetails.Include(e => e.PolicyAssignment).Include(e => e.PolicyFormula).Where(e => e.Id == SalForAppl.Id).SingleOrDefault();
                        ...
                        var SalHeadForm = m.PolicyFormula; //SalaryHeadGenProcess.SalFormulaFinder(x, m.SalaryHead.Id);
                        ...
                        if (SalForAppl.PolicyName.LookupVal.ToUpper() != "")
                        {
                            ...
                            {
                                Id = SalForAppl.Id,
                                PolicyFormula = m.PolicyFormula.Name.ToString(),
                ...
                if (!string.IsNullOrEmpty(gp.searchField) && !string.IsNullOrEmpty(gp.searchString))
                {
                    ...
                    {
                        jsonData = IE.Where(e => (e.PolicyFormula.ToUpper().ToString().Contains(gp.searchString.ToUpper()))
        ...
        public ActionResult Edit(int data)
        {
            using (DataBaseContext db = new DataBaseContext())
            {
                ...
                List<EmployeePolicyStructEditDetails> EmpPolicyStruct = new List<EmployeePolicyStructEditDetails>();

                var EmpPolicyStruct_Details = db.EmployeePolicyStruct.Include(e => e.EmployeePolicyStructDetails).Where(e => e.Id == data).Select(e => e.EmployeePolicyStructDetails).ToList();
                if (EmpPolicyStruct_Details != null)
                {
                    foreach (var ca in EmpPolicyStruct_Details)
                    {
                        EmpPolicyStruct.Add(new EmployeePolicyStructEditDetails
                        {
                            EmpPolicyStructDetails_Id = ca.Select(e => e.Id).ToArray(),
                            //uncomment
                ...
                return Json(new Object[] { Q, EmpPolicyStruct, "", Auth, JsonRequestBehavior.AllowGet });
            }
        }
        ...
        public class EmployeePolicyStructdata
        {
            public int Id { get; set; }
            public string FullNameFML { get; set; }
            public string EmpCode { get; set; }
            public ICollection<EmployeePolicyStruct> EmployeePolicyStruct { get; set; }
        }
        public ActionResult P2BGrid(P2BGrid_Parameters gp)
        {
            try
            {
                ...
                var oemployeedata = db.EmployeePolicyStruct.Where(e => e.EmployeePayroll.Employee.ServiceBookDates != null && e.EndDate == null 
            ...
            try
            {
                ...
                else
                {
                    ...
                    var uids = db.EmployeePayroll
                        ...
                        .ToList();
                    var muids1 = uids.Where(e => e.Employee.ServiceBookDates != null && e.Employee.ServiceBookDates.ServiceLastDate == null && e.EmployeePolicyStruct.Count() == 0).ToList();
            ...
            try
            {
                using (DataBaseContext db = new DataBaseContext())
                {
                    ...
                    foreach (var a in EmpList)
                    {
                        ...
                        var EmployeePolicyStruct = db.EmployeePolicyStruct
                                        .Include(e => e.EmployeePolicyStructDetails)
                                         .Include(e => e.EmployeePolicyStructDetails.Select(t => t.PolicyName))
                                        .Include(e => e.EmployeePolicyStructDetails.Select(t => t.PolicyAssignment))
                                        .Include(e => e.EmployeePolicyStructDetails.Select(t => t.PolicyAssignment.PayScaleAgreement))
                        ...
                        {
                            var OEmployeePolicyStructDet = EmployeePolicyStruct.EmployeePolicyStructDetails.Select(r => r.PolicyAssignment.PayScaleAgreement.Id == PayScaleAgreementId).ToList();
                                    ...
                                    try
                                    {
                                       ...
                                       // q = db.PolicyAssignment.Where(e => e.PayScaleAgreement.Id == PayScaleAgreementId).Select(e => e.PolicyName.Id).ToList();
                                        ...
                                        //{
                                            ...
                                            ServiceBook.EmployeePolicyStructureCreationWithUpdationTest(EmployeePolicyStruct.Id, 0, PayScaleAgreementId, Convert.ToDateTime(EmployeePolicyStruct.EffectiveDate), a.Id, CompanyPayroll_Id.Id);
                                        ...
                                        ServiceBook.EmployeePolicyStructureCreationWithUpdateFormulaTest(EmployeePolicyStruct.Id, 0, PayScaleAgreementId, Convert.ToDateTime(EmployeePolicyStruct.EffectiveDate), a.Id, CompanyPayroll_Id.Id);
