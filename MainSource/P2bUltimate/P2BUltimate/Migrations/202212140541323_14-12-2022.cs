namespace P2BUltimate.Migrations
{
    ...
    public partial class _14122022 : DbMigration
    {
        public override void Up()
        {
            RenameTable(name: "dbo.IncomeTaxITSection", newName: "ITSectionIncomeTax");
            DropForeignKey("dbo.LvSharingPolicy", "LvDebitPolicy_Id", "dbo.LvDebitPolicy");
            DropForeignKey("dbo.LvSharingPolicy", "LvHead_Id", "dbo.LvHead");
            ...
            DropIndex("dbo.LvSharingPolicy", new[] { "LvDebitPolicy_Id" });
            DropIndex("dbo.LvSharingPolicy", new[] { "LvHead_Id" });
            ...
            DropColumn("dbo.LvDebitPolicy", "IsDebitShare");
            DropColumn("dbo.LvDebitPolicy", "IsCertificateAppl");
            DropColumn("dbo.LvDebitPolicy", "MinLvDays");
            ...
            DropTable("dbo.LvSharingPolicy");
            DropTable("dbo.PrefixSuffixAction");
            DropTable("api.APIUsers");
            DropTable("dbo.ErrorLookup");
        ...
        public override void Down()
        {
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Message_Code = c.Int(nullable: false),
                        Info_code = c.Int(nullable: false),
                        Message_Description = c.String(),
                    })
                .PrimaryKey(t => t.Id);
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        LvDebitPolicy_Id = c.Int(),
                        IsPartial = c.Boolean(nullable: false),
                        MinDayAppl = c.Int(),
                        MaxDayAppl = c.Int(),
                        Perference = c.Int(nullable: false),
                        LvHead_Id = c.Int(),
                        FullDetails = c.String(maxLength: 250),
                        RowVersion = c.Binary(nullable: false, fixedLength: true, timestamp: true, storeType: "rowversion"),
                        DBTrack_Action = c.String(maxLength: 1),
            ...
            AddColumn("dbo.LvDebitPolicy", "MinLvDays", c => c.Int());
            AddColumn("dbo.LvDebitPolicy", "IsCertificateAppl", c => c.Boolean(nullable: false));
            AddColumn("dbo.LvDebitPolicy", "IsDebitShare", c => c.Boolean(nullable: false));
            ...
            CreateIndex("dbo.LvSharingPolicy", "LvHead_Id");
            CreateIndex("dbo.LvSharingPolicy", "LvDebitPolicy_Id");
            ...
            AddForeignKey("dbo.LvSharingPolicy", "LvHead_Id", "dbo.LvHead", "Id");
            AddForeignKey("dbo.LvSharingPolicy", "LvDebitPolicy_Id", "dbo.LvDebitPolicy", "Id");
